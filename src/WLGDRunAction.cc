...
*/
    ...
    if(fWriteOutAdvancedMultiplicity)analysisManager->CreateNtupleDColumn("LArEnergyDeposition_delayed_long", fEventAction->GetLArEnergyDeposition_delayed_long());
    if(fWriteOutAdvancedMultiplicity)analysisManager->CreateNtupleDColumn("GeEnergyDeposition_delayed_long", fEventAction->GetGeEnergyDeposition_delayed_long());
    if(fWriteOutAdvancedMultiplicity)analysisManager->CreateNtupleDColumn("LArEnergyDeposition_after_delayed", fEventAction->GetLArEnergyDeposition_after_delayed());
    if(fWriteOutAdvancedMultiplicity)analysisManager->CreateNtupleDColumn("GeEnergyDeposition_after_delayed", fEventAction->GetGeEnergyDeposition_after_delayed());
    ...
    if(fWriteOutAdvancedMultiplicity) analysisManager->CreateNtupleIColumn("Multiplicity_delayed_long", fEventAction->GetMultiplicity_delayed_long());
    ...
    if(fWriteOutAdvancedMultiplicity) analysisManager->CreateNtupleDColumn("EdepPerDetector_delayed_long", fEventAction->GetEdepPerDetector_delayed_long());
    ...
    if(fWriteOutAdvancedMultiplicity) analysisManager->CreateNtupleDColumn("CopyNDetector_delayed_long", fEventAction->GetNDetector_delayed_long());
...
void WLGDRunAction::SetIndividualGeDepositionInfo(G4int answer) { fIndividualGeDepositionInfo = answer; }

void WLGDRunAction::SetIndividualGdDepositionInfo(G4int answer) { fIndividualGdDepositionInfo = answer; }
...
void WLGDRunAction::DefineCommands()
{
    ...
    fMessenger
            ->DeclareMethod("getIndividualGeDepositionInfo", &WLGDRunAction::SetIndividualGeDepositionInfo)
            .SetGuidance(
    ...
    fMessenger
            ->DeclareMethod("getIndividualGdDepositionInfo", &WLGDRunAction::SetIndividualGdDepositionInfo)
            .SetGuidance(
